...
<div>
  <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="30px" width="30px" fill="none" viewBox="0 0 512 512">
...
<div>
  <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="30px" width="30px" fill="none" viewBox="0 0 448 512">
    <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
    <path
  ...
  <button class="button" data-button="share">
    <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="28px" viewBox="0 0 24 24" width="28px">
...
<div class="boxview__controls-buttons boxview__controls-buttons_type_interactive">
  ...
  <button class="button" data-button="zoom-in">
    <svg class="svg-icon"  xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 0 24 24" width="32px">
      <path d="M0 0h24v24H0V0z" fill="none" />
      <path
  ...
  <button class="button" data-button="zoom-out">
    <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 0 24 24" width="32px">
      <path d="M0 0h24v24H0V0z" fill="none" />
      <path
