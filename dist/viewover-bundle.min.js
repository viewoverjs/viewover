...
var B = (e, t, i) => (re(e, t, "read from private field"), i ? i.call(e) : t.get(e)), x = (e, t, i) => {
  if (t.has(e))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(e) : t.set(e, i);
};
var H = (e, t, i) => (re(e, t, "access private method"), i);
const _e = `
...
`, C = document.createElement("dialog");
C.setAttribute("id", "viewover");
C.classList.add("viewover");
C.innerHTML = _e;
...
function fe(e) {
  if (e.target.classList.contains("viewover-open-button")) {
    ...
    if (e.target.parentElement.querySelector("iframe"))
      return e.target.parentElement.querySelector("iframe");
  } else
    return e.target;
}
function xe(e) {
  const t = [], i = [
    ...e.closest("[data-viewover-list]").children
  ];
  for (let n = 0; n < i.length; n++) {
    const o = i[n];
    let r;
    o.classList.contains("viewover-video-wrapper") ? r = o.querySelector("video") : o.classList.contains("viewover-iframe-wrapper") ? r = o.querySelector("iframe") : r = o, t.push(r);
  }
  return t;
}
const J = new Error();
J.name = "Unauthorized Error";
let N;
const ye = (e, t) => {
  const n = [...e.children].find(
    (o) => t.includes(o.localName)
  );
  if (n !== null)
    N = n.localName;
  else
    throw J.message = "Element must contain an image, video or iframe", J;
};
function ze(e, t, i) {
  for (let n = 0; n < e.length; n++) {
    const o = e[n];
    t.includes(o.localName) && (N = o.localName), o.localName === "div" && ye(o, t), i.includes(N) || i.push(N);
  }
}
function ke(e) {
  let t = new Array();
  return ze(e, ["img", "video", "iframe"], t), t;
}
const b = document.getElementById("control-bar"), Ee = document.getElementById("nav-next-button"), Le = document.getElementById("nav-previous-button"), u = document.getElementById("zoom-in-button"), h = document.getElementById("zoom-out-button"), Se = document.getElementById("close-button"), Me = document.getElementById("fullscreen-buttons"), W = document.getElementById(
  "fullscreen-entry-button"
), Q = document.getElementById(
  "fullscreen-exit-button"
), m = document.getElementById("viewover-container"), ae = document.getElementById("viewover-content"), y = document.getElementById(
  "viewover-main-content"
), L = document.getElementById("viewover-media"), v = document.getElementById(
  "viewover-thumbnails-track"
), ee = "76px", Ce = document.getElementById("thumbnails-buttons"), S = document.getElementById(
...
function Be() {
  [...L.children].forEach((t) => {
    t.classList.contains("button") || t.remove();
  });
}
const a = {}, He = (e, t) => {
  if (a.element = document.createElement(`${e}`), a.element.classList.add(`viewover__${e}`), e === "video") {
    const i = document.createElement("source");
    return i.setAttribute("src", t), a.element.setAttribute("controls", ""), a.element.appendChild(i);
  }
  if (e === "img" || e === "iframe")
    return a.element.setAttribute("src", t);
};
async function I() {
  await a.element.decode();
  const e = {
    width: a.element.naturalWidth,
    height: a.element.naturalHeight
  }, t = {
    width: a.element.getBoundingClientRect().width,
    height: a.element.getBoundingClientRect().height
  }, i = {
    width: y.clientWidth,
...
async function U() {
  const e = await I(), t = e.currentSize.height > e.mainContentSize.height, i = e.currentSize.width > e.mainContentSize.width, n = e.naturalSize.height > e.currentSize.height, o = e.naturalSize.width > e.currentSize.width;
  return {
    isScalable: n && o,
    isInvertible: t && i
  };
...
const ne = (e) => {
  e ? (u.setAttribute("disabled", ""), u.style.cursor = "default", u.setAttribute("tabindex", "-1"), [...u.children][0].style.fill = "var(--viewover-icon-color-disable)") : (u.removeAttribute("disabled"), u.setAttribute("tabindex", "0"), u.style.cursor = "pointer", [...u.children][0].style.fill = "var(--viewover-icon-color)");
}, oe = (e) => {
  e ? (h.setAttribute("disabled", ""), h.style.cursor = "default", h.setAttribute("tabindex", "-1"), [...h.children][0].style.fill = "var(--viewover-icon-color-disable)") : (h.removeAttribute("disabled"), h.setAttribute("tabindex", "0"), h.style.cursor = "pointer", [...h.children][0].style.fill = "var(--viewover-icon-color)");
}, Ae = () => {
  u.classList.contains("viewover__zoom-button_visible") || (u.classList.add("viewover__zoom-button_visible"), h.classList.add("viewover__zoom-button_visible")), ne(!0), oe(!0);
}, Z = async () => {
  await I();
  const e = await U();
  e.isScalable && ne(!1), e.isInvertible && oe(!1);
}, Ie = () => {
  u.classList.contains("viewover__zoom-button_visible") && (u.classList.remove("viewover__zoom-button_visible"), h.classList.remove("viewover__zoom-button_visible"));
}, Ve = async () => {
  const e = await I(), t = await U(), i = e.currentSize.width, n = e.currentSize.height, o = e.naturalSize.width, r = e.naturalSize.height;
  if (t.isScalable && (a.element.style.maxWidth = `calc(${i}px + ${o / 20}px)`, a.element.style.maxHeight = `calc(${n}px + ${r / 20}px)`), o - i < o / 20) {
    ne(!0);
    return;
  }
  Z();
  ...
  const e = await I(), t = await U(), i = e.currentSize.width, n = e.currentSize.height, o = e.naturalSize.width, r = e.naturalSize.height;
  if (t.isInvertible && (a.element.style.maxWidth = `calc(${i}px - ${o / 20}px)`, a.element.style.maxHeight = `calc(${n}px - ${r / 20}px)`), i - e.mainContentSize.width < o / 20) {
    oe(!0);
    return;
  }
  Z();
  ...
  if (e.ctrlKey) {
    e.preventDefault();
    const t = await I(), i = await U(), n = t.currentSize.width, o = t.currentSize.height, r = t.naturalSize.width, s = t.naturalSize.height;
    e.deltaY > 0 && i.isInvertible && (a.element.style.maxWidth = `calc(${n}px - ${r / 30}px)`, a.element.style.maxHeight = `calc(${o}px - ${s / 30}px)`), e.deltaY < 0 && i.isScalable && (a.element.style.maxWidth = `calc(${n}px + ${r / 30}px)`, a.element.style.maxHeight = `calc(${o}px + ${s / 30}px)`), Z();
  }
};
async function z(e, t) {
  L.children.length !== 0 && Be(), He(e, t), L.appendChild(a.element), (e === "video" || e === "iframe") && Ie(), e === "img" && l.enableZoom == !0 && (a.element.removeEventListener("wheel", te), a.element.addEventListener("wheel", te), Ae(), Z()), e === "video" && a.element.load(), a.element.style.transition = "var(--viewover-media-transition)";
}
const V = (e, t) => {
  const i = e.src || e.currentSrc;
  z(t, i);
};
function Ne(e, t) {
  e.length === 1 && (e.includes("img") && V(t, "img"), e.includes("iframe") && V(t, "iframe"), e.includes("video") && V(t, "video")), e.length !== 1 && V(t, t.localName);
}
const We = () => {
  let e = window.pageYOffset || document.documentElement.scrollTop, t = window.pageXOffset || document.documentElement.scrollLeft;
  window.onscroll = function() {
    window.scrollTo(t, e);
  }, document.body.style.overflow = "hidden", document.body.style.maxWidth = "100vw";
}, qe = () => {
  window.onscroll = function() {
  }, document.body.style.overflow = "visible", document.body.style.maxWidth = "revert";
};
function ue() {
  return a.element.localName === "iframe" ? a.element.src : a.element.currentSrc;
}
function k(e) {
  const t = [...v.children];
  let i = a.element.src || a.element.currentSrc;
  t.filter((o) => o.querySelector(".viewover__thumbnail").getAttribute("data-viewover-thumbnail-src") !== i).map(
    (o) => o.classList.remove("viewover__thumbnail-wrapper_active")
  ), e.classList.add("viewover__thumbnail-wrapper_active");
}
const E = (e) => {
  const i = e.getBoundingClientRect().right + 23 > window.innerWidth;
  e.getBoundingClientRect().left < 23 && (v.scrollLeft -= window.innerWidth - e.getBoundingClientRect().right - 23), i && (v.scrollLeft += e.getBoundingClientRect().left - 23);
}, he = () => {
  v.offsetWidth < v.scrollWidth ? m.style.setProperty(
...
function F(e) {
  const t = [...v.children];
  let i;
  const n = ue(), r = l.preparedMediaElements.findIndex(
    (d) => d.currentSrc !== void 0 ? d.currentSrc === n : d.src === n
  ) + 1;
  r < l.preparedMediaElements.length ? i = l.preparedMediaElements.find((d, Y) => Y === r) : i = l.preparedMediaElements.at(0);
  const s = i.src || i.currentSrc, w = t.find(
    (d) => d.querySelector(".viewover__thumbnail").getAttribute("data-viewover-thumbnail-src") === s
  );
  z(i.localName, s), e.thumbnails == !0 && (E(w), k(w));
}
function R(e) {
  const t = [...v.children];
  let i;
  const n = ue(), r = l.preparedMediaElements.findIndex(
    (d) => d.currentSrc === void 0 ? d.src === n : d.currentSrc === n
  ) - 1;
  r > -1 ? i = l.preparedMediaElements.find((d, Y) => Y === r) : i = l.preparedMediaElements.at(-1);
  const s = i.src || i.currentSrc, w = t.find(
    (d) => d.querySelector(".viewover__thumbnail").getAttribute("data-viewover-thumbnail-src") === s
  );
  z(
...
const c = {
  ...
  touchHandler: function(e) {
    let t;
    if (typeof e < "u" && typeof e.touches < "u")
      switch (t = e.touches[0], e.type) {
        case "touchstart":
        case "touchmove":
          c.touches[e.type].x = t.pageX, c.touches[e.type].y = t.pageY;
          break;
        case "touchend":
          c.touches.touchend = !0, c.touches.touchstart.x > -1 && c.touches.touchmove.x > -1 && (c.touches.direction = c.touches.touchstart.x < c.touches.touchmove.x ? "right" : "left", c.touches.direction === "right" && R(l.preparedMediaElements), c.touches.direction === "left" && F(l.preparedMediaElements));
      }
  },
  init: function() {
    y.addEventListener(
...
function Oe(e, t) {
  e.preventDefault(), e.key === "ArrowLeft" && R(t), e.key === "ArrowRight" && F(t);
}
function $e(e) {
  console.log(e.target), !e.ctrlKey && !e.shiftKey && (e.deltaY > 0 && F(l.preparedMediaElements), e.deltaY < 0 && R(l.preparedMediaElements));
}
function A() {
  document.fullscreenElement ? document.exitFullscreen() : m.requestFullscreen();
}
function f(e, t) {
  e.classList.remove("button_hidden"), e.setAttribute("tabindex", "0"), e.classList.add("button_visible"), t.classList.remove("button_visible"), t.setAttribute("tabindex", "-1"), t.classList.add("button_hidden");
}
const le = (e, t) => {
  const i = document.createElement("div");
  i.classList.add("viewover__play-icon"), e.appendChild(i);
}, Pe = (e) => ({
  height: e.naturalHeight,
  width: e.naturalWidth
}), je = (e, t) => {
  const { height: i, width: n } = Pe(t);
  i < n && (e.classList.add("viewover__thumbnail-wrapper_horizontal"), t.classList.add("viewover__thumbnail_horizontal")), i > n && (e.classList.add("viewover__thumbnail-wrapper_vertical"), t.classList.add("viewover__thumbnail_vertical")), i === n && n > 0 && (e.classList.add("viewover__thumbnail-wrapper_square"), t.classList.add("viewover__thumbnail_square"));
};
async function D(e) {
  let t;
  const i = document.createElement("div"), n = document.createElement("img");
  if (i.classList.add("viewover__thumbnail-wrapper"), n.classList.add("viewover__thumbnail"), e.localName === "img") {
    t = e.src, n.setAttribute("src", t);
    try {
      await n.decode(), je(i, n);
    } catch (o) {
      console.log(o);
    }
  }
  return e.localName === "iframe" && (t = `https://img.youtube.com/vi/${e.src.substr(
    e.src.lastIndexOf("/") + 1
  )}/mqdefault.jpg`, n.setAttribute("src", t), le(i)), e.localName === "video" && (t = e.getAttribute("poster"), t !== null ? (n.setAttribute("src", t), le(i)) : (n.classList.add("viewover__alternate-thumbnail"), i.classList.add("viewover__alternate-thumbnail-wrapper"))), i.appendChild(n), i;
}
let g, p;
async function Ue(e, t) {
  t ? (m.style.setProperty(
    "--thumbnails-track-height",
    ee
  ), f(S, M)) : f(M, S);
  for (let i = 0; i < e.length; i++) {
    const n = e[i];
    n.localName === "img" && (g = await D(n), p = g.querySelector(".viewover__thumbnail"), p.setAttribute(
      "data-viewover-thumbnail-src",
      n.src
    ), p.setAttribute("data-viewover-thumbnail-type", "img")), n.localName === "video" && (g = await D(n), p = g.querySelector(".viewover__thumbnail"), p.setAttribute(
      "data-viewover-thumbnail-src",
      n.currentSrc
    ), p.setAttribute("data-viewover-thumbnail-type", "video")), n.localName === "iframe" && (g = await D(n), p = g.querySelector(".viewover__thumbnail"), p.setAttribute(
      "data-viewover-thumbnail-src",
      n.src
    ), p.setAttribute("data-viewover-thumbnail-type", "iframe")), v.appendChild(g);
  }
}
function K(e) {
  a.element.localName === "video" ? (a.element.querySelector("source").setAttribute("src", e), a.element.load()) : a.element.setAttribute("src", e);
}
function Ze() {
  const e = [...v.children];
  for (let t = 0; t < e.length; t++) {
    const i = e[t], n = i.querySelector(".viewover__thumbnail"), o = n.getAttribute("data-viewover-thumbnail-type");
    if (o === "img") {
      const r = n.getAttribute(
        "data-viewover-thumbnail-src"
      );
      i.addEventListener("click", () => {
        if (a.element.localName === "img") {
          if (a.element.src === r)
            return;
          K(r);
        } else
    ...
    if (o === "video") {
      ...
      i.addEventListener("click", () => {
        if (a.element.localName === "video") {
          if (a.element.currentSrc === r)
            return;
          K(r);
        } else
          z("video", r);
...
function se() {
  m.style.getPropertyValue(
    "--thumbnails-track-height"
  ) == ee ? (f(M, S), v.classList.remove(
    "viewover__thumbnails-track_visible"
  ), m.style.setProperty("--thumbnails-track-height", "0px"), m.style.setProperty(
    "--viewover-thumbnails-track-margin",
    "0px"
  )) : (f(S, M), m.style.setProperty(
    "--thumbnails-track-height",
    ee
  ), m.style.setProperty(
    "--viewover-thumbnails-track-margin",
    "20px"
  ), v.classList.add("viewover__thumbnails-track_visible")), he();
}
let q;
const X = () => {
  clearTimeout(q), b.style.visibility = "visible", b.style.opacity = "1";
}, T = () => {
  clearTimeout(q), q = setTimeout(() => {
    b.style.visibility = "visible", b.style.opacity = "1";
  }, 100), q = setTimeout(() => {
    b.style.visibility = "hidden", b.style.opacity = "0";
  }, 2e3);
}, Re = (e) => {
  for (; e.firstChild; )
...
function me() {
  [...L.children].forEach((t) => {
    t.classList.contains("button") || t.remove();
  }), Re(v), qe(), document.removeEventListener("keydown", ie), y.removeEventListener("wheel", $e), L.removeEventListener("dblclick", A), a.element.removeEventListener("wheel", te), f(M, S), v.classList.remove(
    "viewover__thumbnails-track_visible"
  ), m.style.setProperty("--thumbnails-track-height", "0px"), m.style.setProperty(
    "--viewover-thumbnails-track-margin",
    "0px"
  ), delete a.element, viewover.close();
}
function Ye() {
  document.fullscreenElement && document.exitFullscreen(), me();
}
function De(e) {
  e.zoom == !0 && (u.addEventListener("click", Ve), h.addEventListener("click", Te)), Se.onclick = () => {
    Ye();
  }, document.addEventListener("keyup", (t) => {
    const i = C.hasAttribute("open");
    t.key === "Escape" && me(), t.key === "Enter" && i && e.fullscreen == !0 && A();
  }), document.addEventListener("fullscreenchange", () => {
    W.classList.contains("button_hidden") ? (f(W, Q), ae.removeEventListener("mousemove", T), b.removeEventListener("mouseenter", X), b.removeEventListener("mouseleave", T), X()) : (f(Q, W), ae.addEventListener("mousemove", T), b.addEventListener("mouseenter", X), b.addEventListener("mouseleave", T));
  });
}
const l = {};
let ie;
const ce = async (e, t) => {
  const i = fe(e), n = i.src || i.currentSrc;
  l.preparedMediaElements = xe(i);
  const o = ke(
    l.preparedMediaElements
  );
  if (l.enableZoom = t.zoom, Ne(o, i), Ee.onclick = () => {
    F(t);
  }, Le.onclick = () => {
    R(t);
  }, ie = (r) => Oe(r, t), document.addEventListener("keydown", ie), c.init(), S.addEventListener("click", se), M.addEventListener("click", se), t.fullscreen == !0 ? (W.addEventListener("click", A), Q.addEventListener("click", A), L.addEventListener("dblclick", A)) : Me.classList.add("viewover__fullscreen-buttons_hidden"), We(), C.showModal(), De(t), t.thumbnails == !0) {
    await Fe(l.preparedMediaElements, !1);
    const s = [...v.children].find(
      (w) => w.querySelector(".viewover__thumbnail").getAttribute("data-viewover-thumbnail-src") === n
    );
    k(s), he(), E(s);
  } else
    Ce.classList.add("viewover__thumbnails-buttons_hidden");
}, ve = document.querySelectorAll("[data-viewover-list]");
let G;
function Ke() {
  for (let e = 0; e < ve.length; e++) {
    ...
    for (let t = 0; t < G.length; t++) {
      const i = G[t];
      if (i.setAttribute("data-viewover-item", ""), i.localName === "video") {
        const n = i.parentElement, o = document.createElement("div"), r = document.createElement("button");
        o.classList.add("viewover-video-wrapper"), r.classList.add("viewover-open-button"), r.classList.add("viewover-open-button_type_video"), n.replaceChild(o, i), o.appendChild(i), o.appendChild(r);
        const s = () => {
          r.style.display = "none";
        }, w = () => {
          r.style.display = "block";
        };
        i.addEventListener("play", s), i.addEventListener("pause", w);
      }
      if (i.localName === "iframe") {
        const n = i.parentElement, o = document.createElement("div"), r = document.createElement("button");
        o.classList.add("viewover-iframe-wrapper"), r.classList.add("viewover-open-button"), r.classList.add("viewover-open-button_type_iframe"), n.replaceChild(o, i), o.appendChild(i), o.appendChild(r);
      }
    }
  }
}
...
function Xe(e) {
  for (let t = 0; t < de.length; t++) {
    const i = de[t];
    if (i.localName !== "video" && i.localName !== "iframe" && (i.style.cursor = "pointer", i.onclick = (n) => {
      ce(n, e);
    }), i.localName === "video" || i.localName === "iframe") {
      const n = i.parentElement.querySelector(
...
class Qe {
  constructor(t) {
    ...
    this.options = t, H(this, P, pe).call(this), H(this, j, ge).call(this);
  }
}
_ = new WeakMap(), O = new WeakSet(), be = function() {
  return {
    fullscreen: this.options.fullscreen || B(this, _).fullscreen,
    thumbnails: this.options.thumbnails || B(this, _).thumbnails,
    zoom: this.options.zoom || B(this, _).zoom
  };
}, $ = new WeakSet(), we = function() {
  this.options == null ? this.updatedOptions = B(this, _) : this.updatedOptions = H(this, O, be).call(this);
}, P = new WeakSet(), pe = function() {
  const t = document.createElement("style");
  t.textContent = Ge, document.head.append(t);
}, j = new WeakSet(), ge = function() {
  H(this, $, we).call(this), Xe(this.updatedOptions);
};
export {
  Qe as default
};
