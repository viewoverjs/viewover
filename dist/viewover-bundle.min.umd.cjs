var be=(s,l,b)=>{if(!l.has(s))throw TypeError("Cannot "+b)};var A=(s,l,b)=>(be(s,l,"read from private field"),b?b.call(s):l.get(s)),H=(s,l,b)=>{if(l.has(s))throw TypeError("Cannot add the same private member more than once");l instanceof WeakSet?l.add(s):l.set(s,b)};var T=(s,l,b)=>(be(s,l,"access private method"),b);(function(s,l){typeof exports=="object"&&typeof module<"u"?module.exports=l():typeof define=="function"&&define.amd?define(l):(s=typeof globalThis<"u"?globalThis:s||self,s.viewover=l())})(this,function(){var z,F,pe,R,ge,Y,fe,D,_e;"use strict";const s=`
...
`,l=document.createElement("dialog");l.setAttribute("id","viewover"),l.classList.add("viewover"),l.innerHTML=s,document.body.appendChild(l);function b(e){if(e.target.classList.contains("viewover-open-button")){if(e.target.parentElement.querySelector("video"))return e.target.parentElement.querySelector("video");if(e.target.parentElement.querySelector("iframe"))return e.target.parentElement.querySelector("iframe")}else return e.target}function ye(e){const t=[],i=[...e.closest("[data-viewover-list]").children];for(let n=0;n<i.length;n++){const o=i[n];let r;o.classList.contains("viewover-video-wrapper")?r=o.querySelector("video"):o.classList.contains("viewover-iframe-wrapper")?r=o.querySelector("iframe"):r=o,t.push(r)}return t}const K=new Error;K.name="Unauthorized Error";let N;const xe=(e,t)=>{const n=[...e.children].find(o=>t.includes(o.localName));if(n!==null)N=n.localName;else throw K.message="Element must contain an image, video or iframe",K};function ze(e,t,i){for(let n=0;n<e.length;n++){const o=e[n];t.includes(o.localName)&&(N=o.localName),o.localName==="div"&&xe(o,t),i.includes(N)||i.push(N)}}function ke(e){let t=new Array;return ze(e,["img","video","iframe"],t),t}const p=document.getElementById("control-bar"),Ee=document.getElementById("nav-next-button"),Le=document.getElementById("nav-previous-button"),m=document.getElementById("zoom-in-button"),g=document.getElementById("zoom-out-button"),Se=document.getElementById("close-button"),Me=document.getElementById("fullscreen-buttons"),W=document.getElementById("fullscreen-entry-button"),X=document.getElementById("fullscreen-exit-button"),w=document.getElementById("viewover-container"),le=document.getElementById("viewover-content"),k=document.getElementById("viewover-main-content"),E=document.getElementById("viewover-media"),d=document.getElementById("viewover-thumbnails-track"),G="76px",Be=document.getElementById("thumbnails-buttons"),L=document.getElementById("thumbnails-outlined-button"),S=document.getElementById("thumbnails-filled-button");function Ce(){[...E.children].forEach(t=>{t.classList.contains("button")||t.remove()})}const a={},He=(e,t)=>{if(a.element=document.createElement(`${e}`),a.element.classList.add(`viewover__${e}`),e==="video"){const i=document.createElement("source");return i.setAttribute("src",t),a.element.setAttribute("controls",""),a.element.appendChild(i)}if(e==="img"||e==="iframe")return a.element.setAttribute("src",t)};async function I(){await a.element.decode();const e={width:a.element.naturalWidth,height:a.element.naturalHeight},t={width:a.element.getBoundingClientRect().width,height:a.element.getBoundingClientRect().height},i={width:k.clientWidth,height:k.clientHeight};return{naturalSize:e,currentSize:t,mainContentSize:i}}async function q(){const e=await I(),t=e.currentSize.height>e.mainContentSize.height,i=e.currentSize.width>e.mainContentSize.width,n=e.naturalSize.height>e.currentSize.height,o=e.naturalSize.width>e.currentSize.width;return{isScalable:n&&o,isInvertible:t&&i}}const J=e=>{e?(m.setAttribute("disabled",""),m.style.cursor="default",[...m.children][0].style.fill="var(--viewover-icon-color-disable)"):(m.removeAttribute("disabled"),m.style.cursor="pointer",[...m.children][0].style.fill="var(--viewover-icon-color)")},Q=e=>{e?(g.setAttribute("disabled",""),g.style.cursor="default",[...g.children][0].style.fill="var(--viewover-icon-color-disable)"):(g.removeAttribute("disabled"),g.style.cursor="pointer",[...g.children][0].style.fill="var(--viewover-icon-color)")},Ie=()=>{m.classList.contains("viewover__zoom-button_visible")||(m.classList.add("viewover__zoom-button_visible"),g.classList.add("viewover__zoom-button_visible")),J(!0),Q(!0)},O=async()=>{await I();const e=await q();e.isScalable&&J(!1),e.isInvertible&&Q(!1)},Ve=()=>{m.classList.contains("viewover__zoom-button_visible")&&(m.classList.remove("viewover__zoom-button_visible"),g.classList.remove("viewover__zoom-button_visible"))},Ae=async()=>{const e=await I(),t=await q(),i=e.currentSize.width,n=e.currentSize.height,o=e.naturalSize.width,r=e.naturalSize.height;if(t.isScalable&&(a.element.style.maxWidth=`calc(${i}px + ${o/20}px)`,a.element.style.maxHeight=`calc(${n}px + ${r/20}px)`),o-i<o/20){J(!0);return}O()},Te=async()=>{const e=await I(),t=await q(),i=e.currentSize.width,n=e.currentSize.height,o=e.naturalSize.width,r=e.naturalSize.height;if(t.isInvertible&&(a.element.style.maxWidth=`calc(${i}px - ${o/20}px)`,a.element.style.maxHeight=`calc(${n}px - ${r/20}px)`),i-e.mainContentSize.width<o/20){Q(!0);return}O()},ee=async e=>{if(e.ctrlKey){e.preventDefault();const t=await I(),i=await q(),n=t.currentSize.width,o=t.currentSize.height,r=t.naturalSize.width,v=t.naturalSize.height;e.deltaY>0&&i.isInvertible&&(a.element.style.maxWidth=`calc(${n}px - ${r/30}px)`,a.element.style.maxHeight=`calc(${o}px - ${v/30}px)`),e.deltaY<0&&i.isScalable&&(a.element.style.maxWidth=`calc(${n}px + ${r/30}px)`,a.element.style.maxHeight=`calc(${o}px + ${v/30}px)`),O()}};async function M(e,t){E.children.length!==0&&Ce(),He(e,t),E.appendChild(a.element),(e==="video"||e==="iframe")&&Ve(),e==="img"&&c.enableZoom==!0&&(a.element.removeEventListener("wheel",ee),a.element.addEventListener("wheel",ee),Ie(),O()),e==="video"&&a.element.load(),a.element.style.transition="var(--viewover-media-transition)"}const $=(e,t)=>{const i=e.src||e.currentSrc;M(t,i)};function Ne(e,t){e.length===1&&(e.includes("img")&&$(t,"img"),e.includes("iframe")&&$(t,"iframe"),e.includes("video")&&$(t,"video")),e.length!==1&&$(t,t.localName)}const We=()=>{let e=window.pageYOffset||document.documentElement.scrollTop,t=window.pageXOffset||document.documentElement.scrollLeft;window.onscroll=function(){window.scrollTo(t,e)},document.body.style.overflow="hidden",document.body.style.maxWidth="100vw"},qe=()=>{window.onscroll=function(){},document.body.style.overflow="visible",document.body.style.maxWidth="revert"};function se(){return a.element.localName==="iframe"?a.element.src:a.element.currentSrc}function B(e){const t=[...d.children];let i=a.element.src||a.element.currentSrc;t.filter(o=>o.querySelector(".viewover__thumbnail").getAttribute("data-viewover-thumbnail-src")!==i).map(o=>o.classList.remove("viewover__thumbnail-wrapper_active")),e.classList.add("viewover__thumbnail-wrapper_active")}const C=e=>{const i=e.getBoundingClientRect().right+23>window.innerWidth;e.getBoundingClientRect().left<23&&(d.scrollLeft-=window.innerWidth-e.getBoundingClientRect().right-23),i&&(d.scrollLeft+=e.getBoundingClientRect().left-23)},ce=()=>{d.offsetWidth<d.scrollWidth?w.style.setProperty("--viewover-thumbnails-track-scroll-height","10px"):w.style.setProperty("--viewover-thumbnails-track-scroll-height","0px")};function P(e){const t=[...d.children];let i;const n=se(),r=c.preparedMediaElements.findIndex(h=>h.currentSrc!==void 0?h.currentSrc===n:h.src===n)+1;r<c.preparedMediaElements.length?i=c.preparedMediaElements.find((h,ae)=>ae===r):i=c.preparedMediaElements.at(0);const v=i.src||i.currentSrc,_=t.find(h=>h.querySelector(".viewover__thumbnail").getAttribute("data-viewover-thumbnail-src")===v);M(i.localName,v),e.thumbnails==!0&&(C(_),B(_))}function j(e){const t=[...d.children];let i;const n=se(),r=c.preparedMediaElements.findIndex(h=>h.currentSrc===void 0?h.src===n:h.currentSrc===n)-1;r>-1?i=c.preparedMediaElements.find((h,ae)=>ae===r):i=c.preparedMediaElements.at(-1);const v=i.src||i.currentSrc,_=t.find(h=>h.querySelector(".viewover__thumbnail").getAttribute("data-viewover-thumbnail-src")===v);M(i.localName,v),e.thumbnails==!0&&(C(_),B(_))}const u={touches:{touchstart:{x:-1,y:-1},touchmove:{x:-1,y:-1},touchend:!1,direction:"undetermined"},touchHandler:function(e){let t;if(typeof e<"u"&&typeof e.touches<"u")switch(t=e.touches[0],e.type){case"touchstart":case"touchmove":u.touches[e.type].x=t.pageX,u.touches[e.type].y=t.pageY;break;case"touchend":u.touches.touchend=!0,u.touches.touchstart.x>-1&&u.touches.touchmove.x>-1&&(u.touches.direction=u.touches.touchstart.x<u.touches.touchmove.x?"right":"left",u.touches.direction==="right"&&j(c.preparedMediaElements),u.touches.direction==="left"&&P(c.preparedMediaElements))}},init:function(){k.addEventListener("touchstart",u.touchHandler,!1),k.addEventListener("touchmove",u.touchHandler,!1),k.addEventListener("touchend",u.touchHandler,!1)}};function Oe(e,t){e.preventDefault(),e.key==="ArrowLeft"&&j(t),e.key==="ArrowRight"&&P(t)}function $e(e){console.log(e.target),!e.ctrlKey&&!e.shiftKey&&(e.deltaY>0&&P(c.preparedMediaElements),e.deltaY<0&&j(c.preparedMediaElements))}function V(){document.fullscreenElement?document.exitFullscreen():w.requestFullscreen()}function y(e,t){e.classList.remove("button_hidden"),e.classList.add("button_visible"),t.classList.remove("button_visible"),t.classList.add("button_hidden")}const ve=(e,t)=>{const i=document.createElement("div");i.classList.add("viewover__play-icon"),e.appendChild(i)},Pe=e=>({height:e.naturalHeight,width:e.naturalWidth}),je=(e,t)=>{const{height:i,width:n}=Pe(t);i<n&&(e.classList.add("viewover__thumbnail-wrapper_horizontal"),t.classList.add("viewover__thumbnail_horizontal")),i>n&&(e.classList.add("viewover__thumbnail-wrapper_vertical"),t.classList.add("viewover__thumbnail_vertical")),i===n&&n>0&&(e.classList.add("viewover__thumbnail-wrapper_square"),t.classList.add("viewover__thumbnail_square"))};async function te(e){let t;const i=document.createElement("div"),n=document.createElement("img");if(i.classList.add("viewover__thumbnail-wrapper"),n.classList.add("viewover__thumbnail"),e.localName==="img"){t=e.src,n.setAttribute("src",t);try{await n.decode(),je(i,n)}catch(o){console.log(o)}}return e.localName==="iframe"&&(t=`https://img.youtube.com/vi/${e.src.substr(e.src.lastIndexOf("/")+1)}/mqdefault.jpg`,n.setAttribute("src",t),ve(i)),e.localName==="video"&&(t=e.getAttribute("poster"),t!==null?(n.setAttribute("src",t),ve(i)):(n.classList.add("viewover__alternate-thumbnail"),i.classList.add("viewover__alternate-thumbnail-wrapper"))),i.appendChild(n),i}let x,f;async function Ue(e,t){t?(w.style.setProperty("--thumbnails-track-height",G),y(L,S)):y(S,L);for(let i=0;i<e.length;i++){const n=e[i];n.localName==="img"&&(x=await te(n),f=x.querySelector(".viewover__thumbnail"),f.setAttribute("data-viewover-thumbnail-src",n.src),f.setAttribute("data-viewover-thumbnail-type","img")),n.localName==="video"&&(x=await te(n),f=x.querySelector(".viewover__thumbnail"),f.setAttribute("data-viewover-thumbnail-src",n.currentSrc),f.setAttribute("data-viewover-thumbnail-type","video")),n.localName==="iframe"&&(x=await te(n),f=x.querySelector(".viewover__thumbnail"),f.setAttribute("data-viewover-thumbnail-src",n.src),f.setAttribute("data-viewover-thumbnail-type","iframe")),d.appendChild(x)}}function ie(e){a.element.localName==="video"?(a.element.querySelector("source").setAttribute("src",e),a.element.load()):a.element.setAttribute("src",e)}function Ze(){const e=[...d.children];for(let t=0;t<e.length;t++){const i=e[t],n=i.querySelector(".viewover__thumbnail"),o=n.getAttribute("data-viewover-thumbnail-type");if(o==="img"){const r=n.getAttribute("data-viewover-thumbnail-src");i.addEventListener("click",()=>{if(a.element.localName==="img"){if(a.element.src===r)return;ie(r)}else M("img",r);B(i),C(i)});continue}if(o==="video"){const r=n.getAttribute("data-viewover-thumbnail-src");i.addEventListener("click",()=>{if(a.element.localName==="video"){if(a.element.currentSrc===r)return;ie(r)}else M("video",r);B(i),C(i)});continue}if(o==="iframe"){const r=n.getAttribute("data-viewover-thumbnail-src");i.addEventListener("click",()=>{if(a.element.localName==="iframe"){if(a.element.src===r)return;ie(r)}else M("iframe",r);B(i),C(i)});continue}}}async function Fe(e,t){await Ue(e,t),Ze()}function de(){w.style.getPropertyValue("--thumbnails-track-height")==G?(y(S,L),d.classList.remove("viewover__thumbnails-track_visible"),w.style.setProperty("--thumbnails-track-height","0px"),w.style.setProperty("--viewover-thumbnails-track-margin","0px")):(y(L,S),w.style.setProperty("--thumbnails-track-height",G),w.style.setProperty("--viewover-thumbnails-track-margin","20px"),d.classList.add("viewover__thumbnails-track_visible")),ce()}let U;const ne=()=>{clearTimeout(U),p.style.visibility="visible",p.style.opacity="1"},Z=()=>{clearTimeout(U),U=setTimeout(()=>{p.style.visibility="visible",p.style.opacity="1"},100),U=setTimeout(()=>{p.style.visibility="hidden",p.style.opacity="0"},2e3)},Re=e=>{for(;e.firstChild;)e.removeChild(e.firstChild)};function ue(){[...E.children].forEach(t=>{t.classList.contains("button")||t.remove()}),Re(d),qe(),document.removeEventListener("keydown",oe),k.removeEventListener("wheel",$e),E.removeEventListener("dblclick",V),a.element.removeEventListener("wheel",ee),y(S,L),d.classList.remove("viewover__thumbnails-track_visible"),w.style.setProperty("--thumbnails-track-height","0px"),w.style.setProperty("--viewover-thumbnails-track-margin","0px"),delete a.element,viewover.close()}function Ye(){document.fullscreenElement&&document.exitFullscreen(),ue()}function De(e){e.zoom==!0&&(m.addEventListener("click",Ae),g.addEventListener("click",Te)),Se.onclick=()=>{Ye()},document.addEventListener("keyup",t=>{const i=l.hasAttribute("open");t.key==="Escape"&&ue(),t.key==="Enter"&&i&&e.fullscreen==!0&&V()}),document.addEventListener("fullscreenchange",()=>{W.classList.contains("button_hidden")?(y(W,X),le.removeEventListener("mousemove",Z),p.removeEventListener("mouseenter",ne),p.removeEventListener("mouseleave",Z),ne()):(y(X,W),le.addEventListener("mousemove",Z),p.addEventListener("mouseenter",ne),p.addEventListener("mouseleave",Z))})}const c={};let oe;const he=async(e,t)=>{const i=b(e),n=i.src||i.currentSrc;c.preparedMediaElements=ye(i);const o=ke(c.preparedMediaElements);if(c.enableZoom=t.zoom,Ne(o,i),Ee.onclick=()=>{P(t)},Le.onclick=()=>{j(t)},oe=r=>Oe(r,t),document.addEventListener("keydown",oe),u.init(),L.addEventListener("click",de),S.addEventListener("click",de),t.fullscreen==!0?(W.addEventListener("click",V),X.addEventListener("click",V),E.addEventListener("dblclick",V)):Me.classList.add("viewover__fullscreen-buttons_hidden"),We(),l.showModal(),De(t),t.thumbnails==!0){await Fe(c.preparedMediaElements,!1);const v=[...d.children].find(_=>_.querySelector(".viewover__thumbnail").getAttribute("data-viewover-thumbnail-src")===n);B(v),ce(),C(v)}else Be.classList.add("viewover__thumbnails-buttons_hidden")},me=document.querySelectorAll("[data-viewover-list]");let re;function Ke(){for(let e=0;e<me.length;e++){re=[...me[e].children];for(let t=0;t<re.length;t++){const i=re[t];if(i.setAttribute("data-viewover-item",""),i.localName==="video"){const n=i.parentElement,o=document.createElement("div"),r=document.createElement("button");o.classList.add("viewover-video-wrapper"),r.classList.add("viewover-open-button"),r.classList.add("viewover-open-button_type_video"),n.replaceChild(o,i),o.appendChild(i),o.appendChild(r);const v=()=>{r.style.display="none"},_=()=>{r.style.display="block"};i.addEventListener("play",v),i.addEventListener("pause",_)}if(i.localName==="iframe"){const n=i.parentElement,o=document.createElement("div"),r=document.createElement("button");o.classList.add("viewover-iframe-wrapper"),r.classList.add("viewover-open-button"),r.classList.add("viewover-open-button_type_iframe"),n.replaceChild(o,i),o.appendChild(i),o.appendChild(r)}}}}Ke();const we=[...document.querySelectorAll("[data-viewover-item]")];function Xe(e){for(let t=0;t<we.length;t++){const i=we[t];if(i.localName!=="video"&&i.localName!=="iframe"&&(i.style.cursor="pointer",i.onclick=n=>{he(n,e)}),i.localName==="video"||i.localName==="iframe"){const n=i.parentElement.querySelector(".viewover-open-button");n.onclick=o=>{he(o,e)}}}}const Ge=`:root{--viewover-icon-color:rgb(140, 140, 140);--viewover-icon-color-hover:rgb(220, 220, 220);--viewover-icon-color-disable:rgb(60, 60, 60);--viewover-background-color:rgba(0, 0, 0, 0.95);--viewover-icon-transition:linear 0.2s;--viewover-media-transition:linear 0.2s}.viewover-iframe-wrapper,.viewover-video-wrapper{display:inline-block;position:relative}.viewover-open-button{background:0 0;border:none;cursor:pointer;width:52px;height:52px;position:absolute;right:10px;background:url(../utils/icons/launch_black_48dp.svg) no-repeat;background-color:#00000050;background-position:center;z-index:1}.viewover-open-button_type_video{top:10px}.viewover-open-button_type_iframe{bottom:10px}@media (any-hover:hover){.viewover-open-button{visibility:hidden;opacity:0}.viewover-video-wrapper:hover .viewover-open-button{visibility:visible;opacity:1}.viewover-iframe-wrapper:hover .viewover-open-button{visibility:visible;opacity:1}}@media (any-hover:none){.viewover-open-button{visibility:visible;opacity:1}}.viewover *,.viewover ::after,.viewover ::before{box-sizing:border-box;margin:0;padding:0}.viewover .button{background:0 0;border:none;cursor:pointer}.viewover .button_hidden{visibility:hidden;opacity:0}.viewover .button_visible{visibility:visible;opacity:1}.viewover:modal{max-width:100%;max-height:100%;user-select:none}.viewover::backdrop{background:rgba(0,0,0,.95)}.viewover{box-sizing:border-box;padding:0;width:100%;height:100%;border:none;background-color:rgba(0,0,0,.95);overflow:hidden}.viewover__container{--viewover-padding:20px;width:100%;height:100%;padding-inline:var(--viewover-padding);padding-block-end:0;--viewover-control-bar-height:60px;--thumbnails-track-height:0px;--viewover-media-margin:10px;--viewover-thumbnails-track-margin:0px;--viewover-thumbnails-track-scroll-height:0px;--viewover-horizontal-thumbnail-aspect-ratio:16/9;--viewover-vertical-thumbnail-aspect-ratio:4/6;--viewover-vertical-thumbnail-width:calc(
