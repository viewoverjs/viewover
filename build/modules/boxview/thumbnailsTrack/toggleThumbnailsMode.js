import { thumbnailsTrackHeight, boxviewContainer, thumbnailsShowButton, thumbnailsHideButton, boxviewThumbnailsTrack } from '../../document/docConstants.js';
...
export default function toggleThumbnailsMode() {
  const trackHeight = boxviewContainer.style.getPropertyValue('--thumbnails-track-height');
  if (trackHeight == thumbnailsTrackHeight) {
    ...
    boxviewContainer.style.setProperty('--boxview-thumbnails-track-margin', '0px');
  } else {
    toggleButtonIcon(thumbnailsShowButton, thumbnailsHideButton);
    boxviewContainer.style.setProperty('--thumbnails-track-height', thumbnailsTrackHeight);
    boxviewContainer.style.setProperty('--boxview-thumbnails-track-margin', '20px');
