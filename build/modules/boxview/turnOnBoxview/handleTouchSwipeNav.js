...
export const handleTouchSwipeNav = {
      ...
      if (typeof event.touches !== 'undefined') {
        ...
        switch (event.type) {
          ...
          case 'touchend':
            ...
            if (handleTouchSwipeNav.touches.touchstart.x > -1 && handleTouchSwipeNav.touches.touchmove.x > -1) {
              handleTouchSwipeNav.touches.direction = handleTouchSwipeNav.touches.touchstart.x < handleTouchSwipeNav.touches.touchmove.x ? 'right' : 'left';
  ...
  init: function () {
    boxviewMainContent.addEventListener('touchstart', handleTouchSwipeNav.touchHandler, false);
    boxviewMainContent.addEventListener('touchmove', handleTouchSwipeNav.touchHandler, false);
    boxviewMainContent.addEventListener('touchend', handleTouchSwipeNav.touchHandler, false);
  }
};