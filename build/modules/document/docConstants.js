...
export const fullscreenEntryButton = document.getElementById('fullscreen-entry-button');
export const fullscreenExitButton = document.getElementById('fullscreen-exit-button');
...
export const boxviewThumbnailsTrack = document.getElementById('boxview-thumbnails-track');
...
export const thumbnailsShowButton = document.getElementById('thumbnails-outlined-button');
export const thumbnailsHideButton = document.getElementById('thumbnails-filled-button');